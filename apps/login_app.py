...
class LoginApp(HydraHeadApp):
    ...
    def run(self) -> None:
        ...
        with st.sidebar:
            ...
            st.button(label='User profile', on_click=None, help="info")
            st.button(label='Support', on_click=None, help="info")
            st.button(label='Frequently Asked Questions', on_click=None, help="info")
            st.button(label='Terms of service', on_click=None, help="info")
            st.button(label='about us', on_click=None, help="info")
    ...
    def _create_login_form(self, parent_container) -> Dict:
        ...
        form_state['access_level'] = login_form.selectbox('Access Level',(1, 2)) # 'Doctor', 'Patient', Clinic
