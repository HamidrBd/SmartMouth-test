...
class SignUpApp(HydraHeadApp):
    ...
    def run(self) -> None:
        ...
        st.markdown("<h1 style='text-align: center;'>Signup page</h1>", unsafe_allow_html=True)
    ...
    def _create_signup_form(self, parent_container) -> Dict:
        ...
        form_state['Name'] = login_form.text_input('Name')
        form_state['Last Name'] = login_form.text_input('Last Name')
        form_state['e-mail'] = login_form.text_input('e-mail')
        form_state['Phone Number'] = login_form.text_input('Phone Number')
        ...
        form_state['access_level'] = login_form.selectbox('Example Access Level',(1, 2)) # 'Doctor', 'Patient'
